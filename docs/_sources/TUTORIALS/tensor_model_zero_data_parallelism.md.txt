...
* [1. Multi-dimensional Parallel Training](#multi-dimensional-parallel-training)
    + [1.1. The concept of multi-dimensional parallel training](#the-concept-of-multi-dimensional-parallel-training)
    + [1.2. The concept of MPU (Model Parallel Unit)](#the-concept-of-mpu--model-parallel-unit-)
* [2. Training](#training)
    + [2.1. Initialize some variables](#initialize-some-variables)
    + [2.2. Create model and optimizer and tokenizer](#create-model-and-optimizer-and-tokenizer)
    + [2.3. Parallelize the model](#parallelize-the-model)
    + [2.4. Make the model ZeRO data parallelizable](#make-the-model-zero-data-parallelizable)
    + [2.5. Load dataset](#load-dataset)
    + [2.6. Create DistributedSampler to parallelize dataset](#create-distributedsampler-to-parallelize-dataset)
    + [2.7. Create the dataloader with sampler.](#create-the-dataloader-with-sampler)
    + [2.8. Do training as usual](#do-training-as-usual)
