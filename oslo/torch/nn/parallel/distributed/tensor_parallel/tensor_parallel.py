...
from oslo.torch.nn.parallel.distributed.tensor_parallel.parallel_1d._wrapper import (
    _TensorParallel1D,
)
from oslo.torch.nn.parallel.utils import unwrap_parallel, ParallelWrapper
