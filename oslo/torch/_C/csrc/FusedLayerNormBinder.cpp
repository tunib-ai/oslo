...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("layer_norm_forward_affine", &layer_norm_affine, "LayerNorm forward (CUDA)");
  m.def("layer_norm_forward", &layer_norm, "LayerNorm forward (CUDA)");
  m.def("layer_norm_backward_affine", &layer_norm_gradient_affine, "LayerNorm backward (CUDA)");
  m.def("layer_norm_backward", &layer_norm_gradient, "LayerNorm backward (CUDA)");
  m.def("layer_norm_forward_affine_mixed_dtypes", &layer_norm_affine_mixed_dtypes, "LayerNorm forward with mixed dtypes (CUDA) compatible with Megatron's implementation");
  m.def("rms_norm_forward_affine", &rms_norm_affine, "RMSNorm forward (CUDA)");
  m.def("rms_norm_forward", &rms_norm, "RMSNorm forward (CUDA)");
  m.def("rms_norm_backward_affine", &rms_norm_gradient_affine, "RMSNorm backward (CUDA)");
  m.def("rms_norm_backward", &rms_norm_gradient, "RMSNorm backward (CUDA)");
  m.def("rms_norm_forward_affine_mixed_dtypes", &rms_norm_affine_mixed_dtypes, "RMSNorm forward with mixed dtypes (CUDA) compatible with Megatron's implementation");
