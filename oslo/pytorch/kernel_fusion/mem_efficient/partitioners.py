...
from oslo.pytorch.kernel_fusion.mem_efficient.compat.partitioners import (
    unrecomputable_ops,
)
...
def draw_graph(
    traced: torch.fx.GraphModule, fname: str, figname: str = "fx_graph", clear_meta=True
):
    if clear_meta:
