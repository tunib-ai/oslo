...
from oslo.pytorch.kernel_fusion.compile.compat.python_key import _make_wrapper_subclass
from oslo.pytorch.kernel_fusion.compile.compat.shape_prop import _extract_tensor_metadata
...
class PythonTensor(torch.Tensor):
    ...
    def __new__(cls, elem, proxy, device=None):
        ...
        r = _make_wrapper_subclass(cls, elem, device)
    ...
    def __torch_dispatch__(cls, func, types, args=(), kwargs=None):
        ...
        input_devices = [
            i.device
            for i in pytree.tree_flatten(args)[0] + pytree.tree_flatten(kwargs)[0]
