"""
Activation checkpointing tutorial step 1:
How to use the torch activation checkpointing for training?
"""
import torch
...
# 4. Turn on torch activation checkpointing
model.gradient_checkpointing_enable()

# 5. Load dataset and create data loader
