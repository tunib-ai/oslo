...
from oslo.transformers.models.roberta.modeling_roberta import RobertaForMaskedLM
...
processor = ProcessorForRobertaPretraining("roberta-base")
...
args = OTrainingArguments(
    ...
    save_steps=100000,
    run_name="test_roberta_pretraining",
)
