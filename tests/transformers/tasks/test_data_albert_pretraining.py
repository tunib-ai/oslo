...
def test_albert_pretraining(model_name, max_length, dataset, mlm_probability=0.15):
    ...
    processor = ProcessorForAlbertPretraining(model_name, max_length)
    ...
    data_collator = DataCollatorForAlbertPretraining(processor, mlm_probability=mlm_probability)
...
def test_sp_collator(
    ...
    sp_data_collator = DataCollatorForAlbertPretraining(processor, parallel_context=parallel_context)
...
if "__main__" == __name__:
    ...
    processor, processed_dataset = test_albert_pretraining("albert-base-v2", 512, dataset, 0.3)
