...
class TestAutoWrap(unittest.TestCase):
    ...
    def test_wrap(self):
        with enable_wrap(wrapper_cls=FSDP, flatten_parameters=False, parallel_context=self.parallel_context):
    ...
    def test_auto_wrap(self):
        ...
        is not set.
        """
        with enable_wrap(wrapper_cls=FSDP, parallel_context=self.parallel_context, flatten_parameters=False):
    ...
    def _auto_wrap_smoke_test(self, enable_mixed_precision):
        ...
        try:
            with enable_wrap(wrapper_cls=FSDP, parallel_context=self.parallel_context, mixed_precision=enable_mixed_precision):
