...
# git clone https://github.com/attardi/wikiextractor.git (has a bug in wikiextractor. see https://github.com/NVIDIA/DeepLearningExamples/issues/1091)
...
# preprocess some data (sentence to token idx occurs ?)
