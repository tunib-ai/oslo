...
def main():
    ...
    result_path = 'results/multi_process_ddp'
    ...
    def chunk(t):
        ...
        return t[dp_rank*ddp_batch_size:(dp_rank+1)*ddp_batch_size]
    ...
    print(f'output', dp_rank, sp_rank)
