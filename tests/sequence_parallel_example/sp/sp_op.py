...
from sp.sp_utils import _calc_incoming_device_range, _calc_current_device_range
...
class RingQK(torch.autograd.Function):
    ...
    def forward(ctx,
        ...
        # backward...
        if ks_save_path is not None:
            torch.save(ks, ks_save_path)
