...
from sp.sp_op import RingQK, RingAV
...
class TransformerSelfAttentionRingTest(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask, ks_save_path=None):
        ...
        mid_outputs.append(query_layer)
        mid_outputs.append(key_layer)
        mid_outputs.append(value_layer)
        mid_outputs.append(attention_scores)
        mid_outputs.append(attention_probs)
        mid_outputs.append(context_layer)

        return output, bias, mid_outputs
